...
<div class="banner-grids">
    <div class="container">
        ...
        <div class="col-md-2 banner-grid">
            <img src="images\a.jpg" class="img-responsive" width="100%" height="80%" alt="">
            <p style="text-align: center">Dr. Karabi Dutta<br>Prof. Zoology & Co-ordinator</p>
        </div>
        <div class="col-md-2 banner-grid">
            <img src="images\b.jpg" class="img-responsive" width="100%" height="80%" alt="">
            <p style="text-align: center">Dr. Manas Das<br> Asst.Prof. Zoology & Co.coordinator</p>
        </div>
        <div class="col-md-2 banner-grid">
            <img src="images\d.jpg" class="img-responsive" width="100%" height="80%" alt="">
            <p style="text-align: center">Dhrubajyoti Barman<br>Trainee & Developer</p>
        </div>
...
<div class="banner-grids">
    ...
    <?php   }   ?>
        ...
        <div class="col-md-2 banner-grid">
            <img src="images\c.jpg" class="img-responsive" width="100%" height="80%" alt="">
            <p style="text-align: center">Tanjun Islam Hazarika<br>Trainee</p>
        </div>
        <div class="col-md-2 banner-grid">
            <img src="images\e.jpg" class="img-responsive" width="100%" height="80%" alt="">
            <p style="text-align: center">Juli Bairagi<br>Studentship</p>
        </div>
        <div class="col-md-2 banner-grid">
            <img src="images\f.png" class="img-responsive" width="100%" height="80%" alt="">
            <p style="text-align: center">Debasena Barman<br>Studentship</p>
        </div>
        <div class="col-md-3 banner-grid">
            <h3>Publications</h3>
        ...
        <div class="col-md-6 banner-grid">
          ...
          <form>
                <table width="400" border="0" cellspacing="2" cellpadding="0">
                    <tr>
                        <td width="29%" class="bodytext"></td>
                        <td width="71%"><input name="name" type="text" id="name" size="32" placeholder="Name"></td>
                    </tr>
                    <tr>
                        <td class="bodytext"></td>
                        <td><input name="email" type="text" id="email" size="32" placeholder="Email"></td>
                    </tr>
                    <tr>
                        <td class="bodytext"></td>
                        <td><textarea name="comment" cols="45" rows="6" id="comment" class="bodytext" placeholder="Comment"></textarea></td>
                    </tr>
                    <tr>
                        <td class="bodytext"> </td>
                        <td align="left" valign="top"> <button id="somebutton" class="btn btn-info btn-fill btn-wd">Submit</button></td>
                    </tr>
                </table>
            ...
            <!-- <div class="banner-grid-sec">
                 <div class="news-grid">
                     <div class="row">
                         <div class="col-md-6">
                             <label>Email</label>
                             <input id="email" type="text" class="form-control border-input" placeholder="" value="">
                         </div>
                     </div>
                 </div>
                 <div class="news-grid">
