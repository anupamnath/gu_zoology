...
<div class="banner">
				 ...
				 <a href="index.php"><img src="images/logo.jpg"  alt="" height="90px"/></a>
		  ...
		  <div class="container">
			 <div class="col-md-3 banner-grid">
				 ...
				 <div class="banner-grid-sec" style="height: 250px !important;">
                   ...
                   <!--  <marquee  direction="up" scrollamount="4" onmouseover="this.stop()" onmouseleave="this.start();" height="100%" bgcolor="transparent"></marquee>-->
	                           <?php
			 ...
			 <div class="col-md-6 banner-grid" width="257px" height="500px">
...
<?php echo "<img class='mySlides img-responsive' src='img/".$row['name']."'style='width:100%'>";?>
	<?php	}	?>
...
<?php echo "<h4 style='color:white;font-size:13px;'>*".$row['subject']."</h4><br>";?>
	<?php	}	?>
			</div>
		</div>
		...
		<div class="col-md-3 banner-grid">
			...
			<div class="banner-grid-sec news_sec" style="height: 250px !important;">
				 <?php
						       $result = mysqli_query($conn, "SELECT * FROM publication ORDER BY id DESC");
						       while ($row = mysqli_fetch_array($result)) {
